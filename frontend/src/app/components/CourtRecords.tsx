...
import { Search, Plus, Eye, Edit, Trash2, Gavel, Calendar, User } from 'lucide-react';
  ...
  const scheduleHearingReminder = (record: typeof formData, residentName: string) => {
    ...
    if (msUntilReminder > 0 && msUntilReminder < 24 * 60 * 60 * 1000) {
      ...
      setTimeout(() => {
        ...
        // Show in-app alert
        alert(`📧 REMINDER: Court hearing for ${residentName} at ${hearingTimeStr} is in 1 hour. Please notify the assigned Social Worker.`);
      }, msUntilReminder);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Add Court Hearing</DialogTitle>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmit} className="bg-[#2F3E46]">Save Record</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
